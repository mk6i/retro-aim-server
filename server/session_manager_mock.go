...
func (_m *MockSessionManager) NewSessionWithSN(sessID string, screenName string) *user.Session {
...
func (_c *MockSessionManager_NewSessionWithSN_Call) Return(_a0 *user.Session) *MockSessionManager_NewSessionWithSN_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_m *MockSessionManager) Remove(sess *user.Session) {
	_m.Called(sess)
}
...
func (_c *MockSessionManager_Remove_Call) Run(run func(sess *user.Session)) *MockSessionManager_Remove_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockSessionManager_Remove_Call) RunAndReturn(run func(*user.Session)) *MockSessionManager_Remove_Call {
	_c.Call.Return(run)
	return _c
}

// Retrieve provides a mock function with given fields: ID
func (_m *MockSessionManager) Retrieve(ID string) (*user.Session, bool) {
	ret := _m.Called(ID)
...
func (_c *MockSessionManager_Retrieve_Call) Return(_a0 *user.Session, _a1 bool) *MockSessionManager_Retrieve_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSessionManager_Retrieve_Call) RunAndReturn(run func(string) (*user.Session, bool)) *MockSessionManager_Retrieve_Call {
	_c.Call.Return(run)
	return _c
}
