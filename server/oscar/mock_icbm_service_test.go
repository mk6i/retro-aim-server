...
// LowerWarnLevel provides a mock function with given fields: ctx, sess
func (_m *mockICBMService) LowerWarnLevel(ctx context.Context, sess *state.Session) {
	_m.Called(ctx, sess)
}

// mockICBMService_LowerWarnLevel_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'LowerWarnLevel'
type mockICBMService_LowerWarnLevel_Call struct {
	*mock.Call
}

// LowerWarnLevel is a helper method to define mock.On call
//   - ctx context.Context
//   - sess *state.Session
func (_e *mockICBMService_Expecter) LowerWarnLevel(ctx interface{}, sess interface{}) *mockICBMService_LowerWarnLevel_Call {
	return &mockICBMService_LowerWarnLevel_Call{Call: _e.mock.On("LowerWarnLevel", ctx, sess)}
}

func (_c *mockICBMService_LowerWarnLevel_Call) Run(run func(ctx context.Context, sess *state.Session)) *mockICBMService_LowerWarnLevel_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *mockICBMService_LowerWarnLevel_Call) Return() *mockICBMService_LowerWarnLevel_Call {
	_c.Call.Return()
	return _c
}

func (_c *mockICBMService_LowerWarnLevel_Call) RunAndReturn(run func(context.Context, *state.Session)) *mockICBMService_LowerWarnLevel_Call {
	_c.Run(run)
	return _c
}
