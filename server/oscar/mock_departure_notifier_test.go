...
// BroadcastBuddyArrived provides a mock function with given fields: ctx, userInfo
func (_m *mockDepartureNotifier) BroadcastBuddyArrived(ctx context.Context, userInfo wire.TLVUserInfo) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, wire.TLVUserInfo) error); ok {
		r0 = rf(ctx, userInfo)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *mockDepartureNotifier_Expecter) BroadcastBuddyArrived(ctx interface{}, userInfo interface{}) *mockDepartureNotifier_BroadcastBuddyArrived_Call {
	return &mockDepartureNotifier_BroadcastBuddyArrived_Call{Call: _e.mock.On("BroadcastBuddyArrived", ctx, userInfo)}
}

func (_c *mockDepartureNotifier_BroadcastBuddyArrived_Call) Run(run func(ctx context.Context, userInfo wire.TLVUserInfo)) *mockDepartureNotifier_BroadcastBuddyArrived_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(wire.TLVUserInfo))
	})
	return _c
}
...
func (_c *mockDepartureNotifier_BroadcastBuddyArrived_Call) RunAndReturn(run func(context.Context, wire.TLVUserInfo) error) *mockDepartureNotifier_BroadcastBuddyArrived_Call {
	_c.Call.Return(run)
	return _c
}
