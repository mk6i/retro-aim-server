...
func (_m *MockUserManager) GetUser(screenName string) (*User, error) {
...
func (_c *MockUserManager_GetUser_Call) Return(_a0 *User, _a1 error) *MockUserManager_GetUser_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockUserManager_GetUser_Call) RunAndReturn(run func(string) (*User, error)) *MockUserManager_GetUser_Call {
	_c.Call.Return(run)
	return _c
}

// UpsertUser provides a mock function with given fields: u
func (_m *MockUserManager) UpsertUser(u User) error {
	ret := _m.Called(u)
...
func (_c *MockUserManager_UpsertUser_Call) Run(run func(u User)) *MockUserManager_UpsertUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(User))
	})
	return _c
...
func (_c *MockUserManager_UpsertUser_Call) RunAndReturn(run func(User) error) *MockUserManager_UpsertUser_Call {
	_c.Call.Return(run)
	return _c
}
