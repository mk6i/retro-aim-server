...
func (_m *mockOServiceChatHandler) ClientVersionsHandler(ctx context.Context, snacPayloadIn oscar.SNAC_0x01_0x17_OServiceClientVersions) oscar.SNACMessage {
...
func (_c *mockOServiceChatHandler_ClientVersionsHandler_Call) RunAndReturn(run func(context.Context, oscar.SNAC_0x01_0x17_OServiceClientVersions) oscar.SNACMessage) *mockOServiceChatHandler_ClientVersionsHandler_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *mockOServiceChatHandler) RateParamsQueryHandler(ctx context.Context) oscar.SNACMessage {
	ret := _m.Called(ctx)
...
func (_c *mockOServiceChatHandler_RateParamsQueryHandler_Call) RunAndReturn(run func(context.Context) oscar.SNACMessage) *mockOServiceChatHandler_RateParamsQueryHandler_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *mockOServiceChatHandler) SetUserInfoFieldsHandler(ctx context.Context, sess *state.Session, snacPayloadIn oscar.SNAC_0x01_0x1E_OServiceSetUserInfoFields) (oscar.SNACMessage, error) {
	ret := _m.Called(ctx, sess, snacPayloadIn)
...
func (_c *mockOServiceChatHandler_SetUserInfoFieldsHandler_Call) RunAndReturn(run func(context.Context, *state.Session, oscar.SNAC_0x01_0x1E_OServiceSetUserInfoFields) (oscar.SNACMessage, error)) *mockOServiceChatHandler_SetUserInfoFieldsHandler_Call {
	_c.Call.Return(run)
	return _c
}

// UserInfoQueryHandler provides a mock function with given fields: ctx, sess
func (_m *mockOServiceChatHandler) UserInfoQueryHandler(ctx context.Context, sess *state.Session) oscar.SNACMessage {
...
func (_c *mockOServiceChatHandler_UserInfoQueryHandler_Call) RunAndReturn(run func(context.Context, *state.Session) oscar.SNACMessage) *mockOServiceChatHandler_UserInfoQueryHandler_Call {
	_c.Call.Return(run)
	return _c
}
