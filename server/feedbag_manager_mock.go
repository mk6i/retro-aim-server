...
func (_m *MockFeedbagManager) Blocked(sn1 string, sn2 string) (user.BlockedState, error) {
	ret := _m.Called(sn1, sn2)

	var r0 user.BlockedState
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string) (user.BlockedState, error)); ok {
		return rf(sn1, sn2)
	}
	if rf, ok := ret.Get(0).(func(string, string) user.BlockedState); ok {
		r0 = rf(sn1, sn2)
	} else {
		r0 = ret.Get(0).(user.BlockedState)
	}
...
func (_c *MockFeedbagManager_Blocked_Call) Return(_a0 user.BlockedState, _a1 error) *MockFeedbagManager_Blocked_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockFeedbagManager_Blocked_Call) RunAndReturn(run func(string, string) (user.BlockedState, error)) *MockFeedbagManager_Blocked_Call {
	_c.Call.Return(run)
	return _c
}
