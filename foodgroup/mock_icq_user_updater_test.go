...
func (_m *mockICQUserUpdater) SetBasicInfo(name state.IdentScreenName, data state.ICQUserInfoBasic) error {
	ret := _m.Called(name, data)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(state.IdentScreenName, state.ICQUserInfoBasic) error); ok {
		r0 = rf(name, data)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *mockICQUserUpdater_SetBasicInfo_Call) Run(run func(name state.IdentScreenName, data state.ICQUserInfoBasic)) *mockICQUserUpdater_SetBasicInfo_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(state.IdentScreenName), args[1].(state.ICQUserInfoBasic))
	})
	return _c
}
...
func (_c *mockICQUserUpdater_SetBasicInfo_Call) RunAndReturn(run func(state.IdentScreenName, state.ICQUserInfoBasic) error) *mockICQUserUpdater_SetBasicInfo_Call {
	_c.Call.Return(run)
	return _c
}
