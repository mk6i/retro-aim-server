...
func (a *APIAnalytics) LogHTTPRequest(r *http.Request, statusCode int, responseTime time.Duration, responseSize int, errorMsg string) {
	// Extract IP address
	ip := r.RemoteAddr
