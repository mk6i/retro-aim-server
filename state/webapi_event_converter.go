...
func ConvertEventForAMF3(event WebAPIEvent) map[string]interface{} {
	...
	case EventTypeTyping:
		if typingEvent, ok := event.Data.(TypingEvent); ok {
...
func ConvertEventsForAMF3(events []WebAPIEvent) []interface{} {
